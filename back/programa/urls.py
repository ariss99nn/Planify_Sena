...
docente_modulo_urlpatterns = [
    path('',                    DocenteModuloListView.as_view(),   name='docente-modulo-list'),
    path('create/',             DocenteModuloCreateView.as_view(), name='docente-modulo-create'),
    path('<int:pk>/update/',    DocenteModuloUpdateView.as_view(), name='docente-modulo-update'),
]