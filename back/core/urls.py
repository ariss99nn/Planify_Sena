...
from docentes.urls import docente_urlpatterns
from aulas.urls import (
    bloque_urlpatterns, 
    equipamiento_urlpatterns, 
    aula_urlpatterns
    )

from programa.urls import (
    programa_urlpatterns,
    version_urlpatterns,
    modulo_urlpatterns,
    docente_modulo_urlpatterns,
)

from competencia.urls import (
...
from ficha.urls import ficha_urlpatterns

from bhorario.urls import bhorario_urlpatterns

from alertas.urls import alertas_urlpatterns

from reportes.urls import reportes_urlpatterns

from planificacion.urls import (
    plan_urlpatterns,
    item_urlpatterns,
...
from exportacion.urls import exportacion_urlpatterns
...
urlpatterns = [
    ...
    path('api/docentes-modulo/',  include((docente_modulo_urlpatterns, 'docentes-modulo'))),
    ...
    path('api/docentes-asignatura/',  include((docente_asignatura_urlpatterns, 'docentes-asignatura'))),
